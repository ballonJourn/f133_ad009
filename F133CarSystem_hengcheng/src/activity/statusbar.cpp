...
static ZKButton* mtimingTextViewButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ...
    ID_STATUSBAR_nameTextViewButton, onButtonClick_nameTextViewButton,
    ID_STATUSBAR_rejectButton, onButtonClick_rejectButton,
    ID_STATUSBAR_timingTextViewButton, onButtonClick_timingTextViewButton,
};
/***************/
...
void statusbar::onCreate() {
    ...
    mtimingTextViewButtonPtr = (ZKButton*)findControlByID(ID_STATUSBAR_timingTextViewButton);
	mstatusbarPtr = this;
	onUI_init();
    // 注册监听全局触摸
